...
export default function App() {
    ...
    return (React.createElement("div", { className: "ihc" },
        ...
        view === "admin" && (React.createElement(AdminDashboard, { config: config, setConfig: persistConfig, leads: leads, updateLeadStatus: updateLeadStatus, updateLeadNotes: updateLeadNotes, archiveLeads: archiveLeads, restoreLeads: restoreLeads, permanentlyDeleteLeads: permanentlyDeleteLeads, metrics: metrics, setPasswordHash: persistPasswordHash, onExit: () => setView("home"), flashToast: flashToast })),
...
/* ================================ ADMIN DASHBOARD ============================ */
function AdminDashboard({ config, setConfig, leads, updateLeadStatus, updateLeadNotes, archiveLeads, restoreLeads, permanentlyDeleteLeads, metrics, setPasswordHash, onExit, flashToast }) {
...
/* ------------------------------ Bootstrap ---------------------------------
   ...
   ============================================================================ */
console.log("%cID'Home Création — build 2026-08-23-g", "color:#9C4420; font-weight:bold; font-size:13px;");
