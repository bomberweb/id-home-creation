...
export default function App() {
    ...
    return (React.createElement("div", { className: "ihc" },
        ...
        view === "discovery-result" && estimate && (React.createElement(DiscoveryResultView, { estimate: estimate, answers: discoveryAnswers, saved: discoverySaved, onSave: saveDiscovery, onNewDiscovery: startDiscovery, onExit: () => { setDiscoveryMode(false); setView("admin"); } })),
